...
lazy_static! {
    static ref KEYWORDS: HashSet<&'static str> = {
        ...
        let keywords = vec![
            ...
            "precedencegroup", "protocol", "struct", "subscript", "typealias", "var", "break", "case",
            "continue", "default", "defer", "do", "else", "fallthrough", "for", "guard", "if", "in",
            "repeat", "return", "switch", "where", "while", "as", "Any", "catch", "false", "is", "nil",
            "rethrows", "super", "self", "Self", "throw", "throws", "true", "try", "associativity",
    ...
    static ref TYPES: HashSet<&'static str> = {
        let types = vec![
            "Int", "UInt", "Float", "Double", "Bool", "String", "Character", "Array", "Dictionary",
            "Set", "Optional", "Any", "AnyObject", "AnyClass", "Never", "Self", "Void",
        ];
    ...
    static ref MODIFIERS: HashSet<&'static str> = {
        let modifiers = vec![
            "final", "lazy", "dynamic", "inout", "mutating", "nonmutating",
            "convenience", "override", "required", "static", "unowned", "weak",
        ];
    ...
    static ref PREPROCESSOR_DIRECTIVES: HashSet<&'static str> = {
        let preprocessor_directives = vec![
            "#if", "#else", "#elseif", "#endif", "#available", "#warning", "#error",
        ];
