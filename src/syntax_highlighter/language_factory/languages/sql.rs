...
lazy_static! {
    ...
    static ref KEYWORDS: HashSet<&'static str> = {
        let keywords = vec![
            ...
            "TABLE", "ALTER", "DROP", "INDEX", "VIEW", "TRIGGER", "PROCEDURE", "FUNCTION", "JOIN",
            "INNER", "LEFT", "RIGHT", "FULL", "ON", "AS", "AND", "OR", "NOT", "NULL", "DISTINCT",
            "GROUP", "BY", "ORDER", "HAVING", "LIMIT", "OFFSET", "UNION", "ALL", "EXCEPT", "INTERSECT",
            "BETWEEN", "LIKE", "IN", "IS", "EXISTS", "CASE", "WHEN", "THEN", "ELSE", "END",
        ];
    ...
    static ref BUILT_INS: HashSet<&'static str> = {
        let built_ins = vec![
            "COUNT", "SUM", "AVG", "MIN", "MAX", "UPPER", "LOWER", "SUBSTRING", "TRIM", "LENGTH",
            "NOW", "CURDATE", "CURTIME", "DATE", "TIME", "DATETIME", "CHAR", "VARCHAR", "TEXT",
            "INT", "INTEGER", "FLOAT", "DOUBLE", "DECIMAL", "BOOLEAN", "BOOL",
        ];
    ...
    static ref MODIFIERS: HashSet<&'static str> = {
        let modifiers = vec![
            "UNIQUE", "PRIMARY", "KEY", "FOREIGN", "REFERENCES", "AUTO_INCREMENT",
        ];
